      ...
      <div class="row g-4">
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item bg-light">
            ...
            <div class="text-center p-4">
              ...
              <small>Fazlur Rahman Hall</small> <br>
              <small>Phone: +8801826-468201</small>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="team-item bg-light">
            ...
            <div class="text-center p-4">
              <h5 class="mb-0">Md. Rakib Islam</h5>
              <small>Mokbul Hossain Hall</small> <br>
              <small>Phone: +8801816-751267</small>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="team-item bg-light">
            ...
            <div class="text-center p-4">
              <h5 class="mb-0">Beauty Akter</h5>
              <small>Mona Hossain Hall</small> <br>
              <small>+8801783-534217</small>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
          <div class="team-item bg-light">
            ...
            <div class="text-center p-4">
              ...
              <small>Fatema Hall</small> <br>
              <small>+8801910-815693</small>
            </div>
          </div>
        </div>
      </div>
